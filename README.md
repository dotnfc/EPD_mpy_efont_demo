...
### 临时切换页面
<img src="image/ex10d2-switch.jpg" width="400" />
...
### 设置
<img src="image/ex10d2-settings.jpg" width="400" />
...
## BLE 配置 APP
使用 Flutter 开发，支持 Windows (需要有 BLE 硬件) 和 Android。可以从[123网盘](https://www.123pan.com/s/6nQ9jv-RMrBh.html) 下载使用。

<img src="image/ble-app.jpg" width="400" />

## 关于时钟
目前系统在开机/复位时，app.py 中会检测芯片的 RTC 时钟是否合理，不合理会从板载的 RX8025T 中读取时间，并更新到 RTC 中，供应用使用。
如果 RX8025T 中的时间不正确，可能需要手工校准一下，这个过程，目前不是自动的。
